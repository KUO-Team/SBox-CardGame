...
{
	public override string Description => Power > 0 ? "Discard up to @ cards, gain 1 Protection for each card discarded this way" : "Discard a card, gain 1 Protection for each card discarded this way";
